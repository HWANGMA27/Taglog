...
public class ApiExceptionAdvice {
    ...
    public ResponseEntity<ApiExceptionEntity> noteExceptionHandler(HttpServletRequest request, final RuntimeException e) {
    ...
    public ResponseEntity<ApiExceptionEntity> categoryExceptionHandler(HttpServletRequest request, final RuntimeException e) {
        log.info(e.getMessage());
        return ResponseEntity
